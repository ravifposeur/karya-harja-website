...
export default function MaintenancePage() {
  ...
  return (
    <main className="min-h-screen w-full bg-topografi bg-cover bg-center bg-fixed overflow-hidden relative flex items-center justify-center px-6 py-12 md:px-16 gap-12">
      ...
      <div className="w-full max-w-md flex flex-col items-center gap-10 z-10 md:grid md:grid-cols-12 md:max-w-6xl md:gap-x-16 md:gap-y-6 md:items-center">
        {/* ================================================================
      ...
      <a
        ...
        className="fixed bottom-6 right-6 md:bottom-20 md:right-10 z-50 glass p-4 rounded-full w-18 h-18 md:w-20 md:h-20 flex items-center justify-center text-secondary-brand shadow-2xl transition-all duration-300 hover:scale-110 hover:rotate-12 active:scale-90 border border-white/30 group"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 448 512"
          fill="currentColor"
          className="w-8 h-8 md:w-10 md:h-10 transition-colors duration-300 group-hover:text-[#25D366]"
        >
