  ...
  return (
    <div className="fixed bottom-5 right-5 md:bottom-8 md:right-8 z-[100] flex flex-col items-end">
      ...
      <motion.button
        ...
        className="glass p-3 rounded-full w-14 h-14 flex items-center justify-center text-secondary-brand shadow-lg border border-white/30 transition-colors hover:text-[#25D366]"
      >
        {isOpen ? (
          <svg
            xmlns="http://www.w3.org/2000/svg"
